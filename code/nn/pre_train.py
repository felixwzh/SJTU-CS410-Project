...
def pre_train(x_train , x_test):
	...
	model_hidden1.fit(x_train, x_train, epochs=FLAGS.pre_epoch, batch_size=100, validation_data=(x_test, x_test))
	...
	model_hidden2.fit(x_train, x_train, epochs=FLAGS.pre_epoch, batch_size=100, validation_data=(x_test, x_test))
	...
	model_hidden3.fit(x_train, x_train, epochs=FLAGS.pre_epoch, batch_size=100, validation_data=(x_test, x_test))
